...
public class EmGpio {
    ...
    public final static int GPIO_BARCODE_1D_WAKE = 1;
    public final static int GPIO_BARCODE_2D_TRIG = 2;
    public final static int GPIO_BARCODE_1D_TRIG = 3;
    public final static int GPIO_BGM_ENABLE = 4;
    //public final static int GPIO_EINT_CTP = 5; //????
    public final static int GPIO_BGM_CAL = 6;
    public final static int GPIO_UART_TX2 = 7;
    public final static int GPIO_UART_RX2 = 8;
    public final static int GPIO_BGM_INT = 10;  //????
    public final static int GPIO_BGM_MKEY = 57;
    public final static int GPIO_BGM_POWER = 69;
    public final static int GPIO_BGM_BOOT = 74;
    public final static int GPIO_TEMPERATURE = 73;
    public final static int GPIO_1D_EN = 21;
    ...
    public static native boolean eintMask(int eintIndex);

    public static native boolean eintUnMask(int eintIndex);

    public static native boolean eintSetPolarity(int eintIndex);
